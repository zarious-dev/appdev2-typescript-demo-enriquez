let hobbies:string[] = ["Sleeping", "Reading"]
hobbies.push("Watching")

console.log(hobbies)


let userList1: (string | number)[];
let userList2: Array<string | number>;

userList1 = ["Caezarie", "Caezarie111", 123456]
userList2 = ["Radleigh", "Radleigh222", 789012]
